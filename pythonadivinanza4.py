...
"""Aqui genero una variable jugar que haga que el jugador pueda decidir si quiere jugar, si escribe 1 procederá con el juego, pero si 
escribe 2 les escribe Nos vemos y le saca del programa"""
jugar = int(input("¿Quieres jugar?: si (1), no (2)"))
if int(jugar) == 1:
    print("Adelante")
elif int(jugar) == 2:
    print("Nos vemos")
    exit()
import random
"""Aqui genero el número aleatorio con el random, pero le tengo que poner randint para que genera un número entero
...
if intento == intentos:
     print(f"OOOOOOoooooo, se acabo el juego. El número era {numero_random}. Prueba suerte a la próxima")